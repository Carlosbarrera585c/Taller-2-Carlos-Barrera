...
<html lang="es"><!--esto es para que el navegador lea la pagina y reconozca que es en español-->
    ...
    <body>
        <div align="center">INSERTAR EN TABLA CENTRO</div>
        <div align="center">
            <form action="insertar.php" name="IR" method="post">
                <table>
                    <tr>
                        <td>Inserte el Codigo del Centro</td>
                        <td><label>
                                <input type="text" name="codcentro" />
                            </label></td>
                    </tr>
                    <tr>
                        <td>Describa el Centro:</td>
                        <td>
                            <input type="text" name="descentro" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Escriba la Direccion</td>
                        <td>
                            <input type="text" name="direccion" />
                        </td>
                    </tr>
                    <tr></tr>
                    <td>Escriba el Codigo de la Ciudad</td>
                    <td>
