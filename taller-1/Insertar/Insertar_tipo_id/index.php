...
<body>
<div align="center">INSERTAR EN TABLA TIPO ID</div>
<div align="center">
  ...
  <table>
    <tr>
      ...
      <td><label>
        <input type="text" name="codtipoid" />
      </label></td>
    </tr>
    <tr>
      <td>Describa el Tipo de Documento</td>
      <td>
          <input type="text" name="destipoid" />
      </td>
    </tr>
    <tr>
      <td>Escriba el Tipo de Documento</td>
      <td>
