...
<html lang="es"><!--esto es para que el navegador lea la pagina y reconozca que es en español-->
    ...
    <body>
        <div align="center">INSERTAR EN TABLA DESERCION</div>
        <div align="center">
            <form action="insertar.php" name="IR" method="post">
                <table>
                    <tr>
                        <td>Escriba el Numero de Documento</td>
                        <td><label>
                                <input type="text" name="numdoc" />
                            </label></td>
                    </tr>
                    <tr>
                        <td>Escriba la Fecha</td>
                        <td>
                            <input type="text" name="fecha" />
                        </td>
                    </tr>
                    <tr>
                        <td>Escriba la Identificacion del Aprendiz</td>
                        <td>
                            <input type="text" name="idapre" />
                        </td>
                    </tr>
                    <tr>
                        <td>Escriba el Numero de la Ficha</td>
                        <td>
                            <input type="text" name="numficha" />
                        </td>
                    </tr>
                    <tr>
                        <td>Escriba el Codigo de la Causa</td>
                        <td>
                            <input type="text" name="codcausa" />
                        </td>
                    </tr>
                    <tr>
                        <td>Escriba la Fecha de Desercion</td>
                        <td>
                            <input type="text" name="fechadeser" />
                        </td>
                    </tr>
                    <tr>
                        <td>Escriba la Fase de Desercion</td>
                        <td>
                            <input type="text" name="fasedeser" />
                        </td>
                    </tr>
                    <tr>
