...
$sql = "SELECT count(aprendiz.id_apre), desc_centro
FROM aprendiz, desercion, centro, ficha
WHERE desercion.id_apre=aprendiz.id_apre
and desercion.num_ficha=ficha.num_ficha
and ficha.cod_centro=centro.cod_centro group by desc_centro";
...
<body><h2><CENTER>CONSULTA 3</CENTER></h2>
    <table border="5" align="center">
        <tr>
            <th>
                CANTIDAD DE APRENDIZES
            </th>
            <th>
