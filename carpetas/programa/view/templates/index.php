...
<html lang="es">
    ...
    <center>
        ...
        <div id="lnkNuevo">
            <a href="index.php?action=create"><button>Nuevo Programa</button></a>
        </div>
        <?php if (isset($error)): ?>
            ...
            <tbody>
                <?php foreach ($datos as $row): ?>
                    <tr>
                        ...
                        <td><a href="index.php?action=update&amp;cod_pro=<?php echo $row['cod_pro'] ?>">Modificar</a> - <a href="index.php?action=delete&amp;cod_pro=<?php echo $row['cod_pro'] ?>">Eliminar</a></td>
                    </tr>
                <?php endforeach ?>
            </tbody>
        </table>
